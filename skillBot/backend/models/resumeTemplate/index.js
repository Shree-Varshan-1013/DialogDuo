module.exports = (values) => {
    ...
    if (education != "" && education != null)
        htmlTemplate += `<p class="rela-block caps side-header">Education</p>
                  <p class="rela-block list-thing">${education}</p>`;
    ...
    if (experience != "" && experience != null)
        htmlTemplate += `<p class="rela-block social mb-0"><span style="padding-right: 15px; font-size="20px;"><i class="fas fa-globe"></i></span>${experience}</p>`;
    if (projects != "" && projects != null)
        htmlTemplate += `<p class="rela-block social mb-4"><span style="padding-right: 15px; font-size="20px;"><i class="fab fa-linkedin"></i></span>${projects}</p>`;
    if (contact != "" && contact != null)
        htmlTemplate += `<p class="rela-block social mb-0"><span style="padding-right: 15px; font-size="20px;"><i class="fab fa-facebook"></i></span>${contact}</p>`;
    htmlTemplate += `</div>
      </div>
      </body>
      </html>
